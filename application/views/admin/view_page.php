        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_5" data-toggle="tab">Actitvities</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            */ ?>
                            ...
                            <h3 class="sec_title">Actitvities Section</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab_5">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Actitvities Heading </label>
                                    <div class="col-sm-6">
