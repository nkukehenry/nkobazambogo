...
<div class="slider">
    <div class="slide-carousel slider-one owl-carousel">
        ...
        foreach ($sliders as $slider) {
            ...
            style="background-image:url(<?php echo base_url(); ?>public/uploads/<?php echo $slider['photo']; ?>);" >
...
<div class="about-area pt_40 pb_90">
    <div class="container">
        <div class="row">
...
<div class="feature-area feature-two bg-area pt_50 pb_40" style="background-color: var(--mainFaded);">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline" style="padding-bottom: 0px;">
                    <h2 class="text-white"><?php echo $page_home['home_feature_title']; ?></h2>
        ...
        <div class="row">
            ...
            foreach ($features as $row) {
                ...
                <div class="col-lg-4 col-md-6" >
                    ...
                    style="min-height: 170px; border:2px double var(--mainColor)">
...
<div class="portfolio-area pt_50 pb_90">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
                    <h2 class="mainText"><?php echo $page_home['home_portfolio_title']; ?></h2>
                ...
                <div class="portfolio-menu">
                    <ul id="filtrnav">
                        ...
                        foreach ($portfolio_category as $row) {
                            ?>
                            <li class="filtr" data-filter="<?php echo $row['category_id']; ?>"><?php echo strtoupper($row['category_name']); ?></li>
                            <?php
                        }
                        ?>
                    </ul>
...
<div class="services-area pt_20 pb_90">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
                    <h2 class="mainText"><?php echo $page_home['home_service_title']; ?></h2>
        ...
        <div class="row">
            ...
            foreach ($services as $row) {
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text" style="background-color: var(--mainFaded)">
                            <h3><a href="<?php echo base_url(); ?>activities/view/<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a></h3>
                           <p class="text-white">
                                <?php echo substr(nl2br($row['short_description']),0,45); ?>...
                            </p>
                            <div class="button-bn" >
                                <a href="<?php echo base_url(); ?>activities/view/<?php echo $row['id']; ?>">Read More <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ?>
                            ...
                            <div class="row" style="text-align: center; padding-top: 5%; ">
                                ...
                                <a href="<?php echo base_url(); ?>activities/" class="mainText">See More <i class="fa fa-chevron-circle-right"></i></a>
                                  </div>
                            </div>
    </div>
</div>
                ...
                <div class="offset-md-2 col-md-8 offset-md-2 offset-lg-0 col-lg-4">
                    <div class="price-item">
                        ...
                        <div class="price-footer">
                            <div class="button-df">
                                <a href="<?php echo $row['button_url']; ?>/<?php echo $row['title']; ?>"><?php echo $row['button_text']; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--Brand-Area Start-
<div class="brand-area bg-area pt_90 pb_90" style="background-color: #fff;">
    <div class="container">
        <div class="row" >
            <div class="col-12">
                    ...
                    foreach($clients as $row) {
                        ...
                        <?php else: ?>
                            <div class="brand-item" >
                                <img src="<?php echo base_url(); ?>public/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['name']; ?>" width="80px">
                            </div>
                        <?php endif; ?>
                        <?php
                    }
