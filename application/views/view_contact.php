...
<!--Contact Start-->
<div class="contact-area pt_5 pb_90">
    <div class="container">
            ...
            <div class="col-12">
                <div class="contact-form headstyle pt_90">
                    ...
                    if($this->session->flashdata('success')) {
                        ...
                        //display clicked Product if there's
                      echo (!empty($product)) ? "<h3> Your Order: <span class='text-info' >".$product."</span></h3> <br>": '';
                    ?>
                    <?php echo form_open(base_url().'contact/send_email',array('class' => '')); ?>
                        <div class="form-row row">
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" placeholder="<?php echo SUBJECT; ?>" name="subject" required value="<?php echo (!empty($product))? 'Subscription to '.$product : ''; ?>">
                            </div>
