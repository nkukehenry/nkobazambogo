        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-12">
                    <div class="logo flex">
                        <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>public/uploads/<?php echo $setting['logo']; ?>" style="max-width: 700px; " alt="Logo"></a>
                    </div>
                </div>
                    ...
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>products">ACTIVITIES</a></li>
                             ...
                             <?php
                             /*
                             $portfolios = $this->Model_common->getPortfolios();

                              foreach ($portfolios as $row):
                             ?>
                             <li ><a href="<?php echo base_url(); ?>showcase/<?php echo $row->category_id; ?>">
